          ...
          <div className="w-full max-w-md p-8 bg-surface border border-white/10 rounded-3xl">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                disabled={isDeleting}
                className="flex-1 px-6 py-3 rounded-xl bg-red-500 text-white text-xs font-bold uppercase tracking-widest hover:scale-105 active:scale-95 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {isDeleting ? (
                  <>
