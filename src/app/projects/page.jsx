...
export default async function ProjectsPage() {
  ...
  return (
    <div className="min-h-screen relative w-full max-w-[1400px] mx-auto px-4 sm:px-12 md:px-24 lg:px-48 py-16 sm:py-24 md:py-32">
      ...
      <header className="relative mb-16 sm:mb-24 md:mb-32 ml-6 sm:ml-16 md:ml-32">
      ...
      <div className="relative">
        ...
        <div className="flex flex-col gap-48">
          {projects.map((project, index) => (
            <div key={project.id} className="relative group pl-8 sm:pl-24 md:pl-32 lg:pl-48">
